public class DollarAccount extends Account {
    ...
    /* Default Dollar account constructor
     * ARGUMENTS:
     *   - None
     * RETURNS:
     *   - None
     ...
     *   - None
     */
    public DollarAccount(int number, double limit, double current_sum, String name1)
    {
        super(name1);
        this.number = number;
        this.limit = limit;
    ...
    public void print()
    {
        System.out.println("Dollar account: ");
        super.print();
